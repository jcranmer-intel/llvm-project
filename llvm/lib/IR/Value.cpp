...
Value::Value(Type *ty, unsigned scid)
    : SubclassID(scid), HasValueHandle(0), IsUsedByMD(false), HasName(false),
      HasMetadata(false), SubclassData(0), NumUserOperands(0),
      SubclassOptionalData(0), VTy(checkType(ty)), UseList(nullptr) {
